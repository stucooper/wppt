...
played in the centre of the United States. Before the Louisiana
Purchase in 1802, this land belonged to France. Poque used a 20-card
deck (AKQJT in four suits).

Four players were dealt a Five cards and the highest hand won. There
were no Straights or Flushes. The only hand to use all full five cards
as a Complete Hand without kickers was a Full House which is why it was
called Full. There was no ``high card'' hand; AKQJT was the
only possible non-pair hand and was the lowest possible hand. American
pronunication turned the name Poque into Poker.

Some popular non-poker card games today are played with four players
at a square card table and the entire deck dealt to them. Bridge is
the most popular of these; a bidding, tricks and trumps game with the
four players dealt thirteen cards each. Solo Whist is a related game
...
simpler versions of this family of games.
...
home game variations use them, but the major poker games use the
standard 52 cards deck. There have been five major poker games: Five
Card Draw, Five Card Stud, Seven Card Stud, Texas Holdem and Omaha.
