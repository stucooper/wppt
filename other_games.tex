...
board is 1 poker hand. Using One of your hole cards and four from the
board (a Single-Card hand) can be done in 10 ways. Using both your
hole cards and three from the board (a Double-Card hand) can be done
in 10 different ways. So there are 21 different poker hands you can
make at a showdown in Holdem. This is the same as Seven Card
stud.. you're making the best Five Card poker hand from a group of
Seven Cards.
