...
My advice on this flop is to bet small, about half the pot. This small
bet should get a curiosity call from second pair and get all the
longshot runner-runner chances to fold. If you pick up the pot as is,
it's frustrating that you're winning a small hand with a huge made
hand but you probably wouldn't have got much action later on in the
hand anyhow.
...
everyone folding to the shove makes this play a winner.
...
you might be better off just calling bets and getting paid big if
your hit your draw, and losing a bit or trying a river bluff if it
misses. It's great in poker getting paid off big on the river. In this
circumstance you don't have fold equity (Payoff Wizards always call)
but you've got maximum implied odds. This makes this hand a Win
Big/Lose Small hand for you.

Don't just shove with draws, shove with top/top and sets.
...
sometimes he'll put you on a draw shove and call very weakly with a
poor made hand like middle pair and you're a massive favourite and
you don't even have to worry about the draw coming in! This
is a great feeling in poker when you've basically value shoved and
got called.

\subsection{Defending the draw shove}

Firstly you need to have flopped a very good  hand to defend against
the draw shove, top-top, two pair or a set. Sometimes a draw shover
has a nut flush draw with Ace-x suited, and if you don't have an Ace
...
two pair or a set and you haven't even got the draw yourself.
The ``have a good hand'' stipulation in the previous paragraph should
...
In the chapter on Made Hand versus Drawing Hand I looked at
two-way hands; that flop some made hand value plus drawing value.
These holdings are great candidates for defending a draw shove
because if they're behind on made-hand they can hit their draw,
and if they're behind on the draw then they're ahead on made hand
and they should win if the draw misses. It's very rare for
a two-way hand to be losing as both a worse Made Hand and a worse
Draw.
...
you feel sick and you're out of the Tournament. Nevermind,
you played the hand very well. These things happen. Sometimes all
your chips will correctly be in on the flop and it's up to the runout
to determine the winner.

\subsection{My favourite Draw Shove}

This was in a big \$600 multi-day 1 game, in the first level of 100/200
with stacks close to the start stack of 60,000. I've called
a preflop raise of 600 holding K5 of diamonds. K5 is of course
trash but this is the first level and a 600 call is only 1\% of my
stack so I'll see if I flop a miracle. There's a second caller
and three of us see a flop which is 432 two diamonds. The other caller
leads with a 3k bet. I call and the preflop raiser (with 99) raises to
11k with his overpair. The bettor calls the 11k and with my
combo draw (up and down straight draw, King-high flush draw) I draw
shove for 50k more.

The raiser folds pretty quickly, the caller thinks about
it for a bit over a minute then calls.. with QT of diamonds! He has
the flush draw as well but it's a lower flush draw than mine and if
the runout comes brick-brick I'll win on high-card King!

The turn is the Ace of Diamonds and I'm the winner. The river is an
offsuit 9 and had the preflop bettor stayed in he would've finished
with an annoyingly worthless 999 set.

It's rare to get an early double up of a huge 60k stack in the first
level, but in this hand from January 2025 I'm now at 125k. I continue
making big hands and I finish  with the enormous stack of 908k. With
all the Day 1 flights there are 1530 players in this tournament, 396
make it through to Day 2. I do well on Day 2 and finish 20th, turning
my \$600 buyin into \$4,700.
