...
four-of-a-kind plus Ace boards. The full list of unbeatable boards are
...
You can also solve this problem by Rule of Four for your seven outs on
the flop is 7 x 4 = 28\%. You then Rule of Two your three new outs
from the turn giving you 3 x 2 = 6\%; add them together for 34\%.
...
39.1 You can make six Five-Card poker hands from a group of six
cards. You have to leave out one and only one of your six cards to
make a Five-Card poker hand, and there's six different ways of doing
that.

39.2 There is one and only one way of playing the board = 1 hand. For
Single-Card hands, you use one of your four hole cards, (four ways of
doing that) and you have to not use one of the five Board cards (five
ways of doing that). Four time five is 20. So 60 Double-Card hands +
20 Single-Card Hands + 1 Playing the Board hand is a zany 81 Possible
hands.

39.3. There are three ways of using two of your three hole
