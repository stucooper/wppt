...
raise. An early position player with a monster hand like \Ks\Kc\ or
\Ad\Kd\ is hoping you'll raise so he can come over the top.
...
be any better, \As\Ac\ . I announce ``all-in'', pretty quickly. The
two blinds fold quickly but UTG and the cutoff both call.

I'm up against \sevd\fived\ and \Kh\Qc\ . The flop is \eigc\eigd\tres\,
the turn is \Jd\ and I've won the hand by the turn. The river comes
\Ah\ , allowing me to quote Teddy KGB from Rounders: ``Aces full,
Mike''.
...
% FIXME: next paragraph is out of sequence might belong earlier
% before the "At the tables" section.
