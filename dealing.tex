...
Although in this book I present every flop high-to-low (except the ones just above)
don't rearrange the flop order of the physical cards on the table. Keep them in
the order that they came out, left-to-right, but do announce the flop
...
it's a fundamental and key Holdem skill. Put the turn card to the right of the flop
and the river card to the right of the turn. That way a player trying to rewind the hand
can see what the flop was, what the turn was and what the river was.
