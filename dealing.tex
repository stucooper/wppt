...
% FINALFIXME: Check xref chapter number above
...
Start at the small blind and deal to the stacks, finishing with
yourself on the Button. If you're at a big oval table and an awful
dealing position like one of the end seats, deal the cards to the
other side as far as you comfortably can and ask other players to pass
the cards for you.
...
cards closer (if you can reach them) or ask someone to pass them right
to the player. If somebody really wants to stare at their mobile phone
during all of a poker deal I think they deserve to be folded but
unfortunately they still get to play their hand.
...
Put that Jack of Spades back on top of the deck. Now you won't forget
...
to burning every time they flop. The right thing to do is simply
put the burn card back on top of the deck, where the first burn card
always is. Remember a burn card protects card-marking cheats from
guessing what a community card is, so you're protecting one of the
flop cards from cheats by putting the Jack of Spades on it.
...
When you're dealing you'll need to maintain four separate areas of the
table. These are the pot, the muck, the community cards (which include
the burn cards) and the betting from the current round. Keep these
four areas of the table visibly separate and you'll minimise the
chance of errors.

\section{Protect the muck}

If someone throws their cards into the muck, that's where they stay.
A lot of players fold out of turn preflop and then see
they're out of turn and try to retrieve their cards from the muck
so they can fold again, this time in turn. Yuck! Keep the
folded cards in the muck and ask the player to act in turn next time.

Some inattentive big blinds will instantly fold, especially if the
dealer hasn't asked for the blinds to be in place before dealing. You
will be making sure the blinds are in place before you deal the hole
cards, so if the big blind still folds when he didn't have to and he
could have taken a flop for free in an unraised pot, he really has no
excuse. Once a hand is folded it stays folded.
...
Just before performing the flop, I announce how many players
are still active in the hand. ``Runners'' is well understood slang for
the number of still-active players. If play shrinks down to two
people, as soon as the third player exits the hand I announce
``heads-up''.
...
``Ace Ten Six, rainbow''. \fourc\Qc\Ac\ is ``Ace Queen Four, all clubs''.

Although in this book I present every flop high-to-low
(except these three) don't actually rearrange the flop order of the
...
Occasionally you'll be dealing to a total beginner. He won't be
keeping his cards on the table and might try showing them to friends
for advice on how to act. He'll never know when the action is on him.
...
can call for 600, fold, or raise for 1,200 or more''. Calling all
players ``Sir'' or ``Madam'' is a nice touch.

You still need to enforce rules on the beginner. Make sure it's one
player to a hand, and that he doesn't string bet.
...
% I like this seciont but want the chapter to fit to 6 pages
...
\section{Never deal a rabbit card}

Rabbit hunting (wanting to see what the river would have been even
though someone has already won the pot with a turn bet that nobody
called) isn't allowed. The hand is already over. Rabbit hunting is bad
for your poker for reasons I explain in the Decisions and Outcomes
chapter. Don't show rabbit cards to other people, and don't peek at a
rabbit card yourself. The hand is over already.

A small piece of poker terminology you might not have heard: if the
pot is won by a bet on the flop and someone wants to see what both the
turn and the river would have been, it's called a Fox Hunt. Fox
hunting is even worse for your own game than rabbit hunting.

Some tournament directors impose penalties on players, dealers, or
both who show rabbit cards.
