...
take the flop. The big blind has \Ah\Jc. The flop comes
...
House? \textit{Hint: This is three percentages, added together. You
  can hit on the turn and hit again on the river. You can hit on the
  turn and miss on the river. You can miss on the turn but hit on the
  river. Add these three percentages up for the answer. Or, you can
  calculate the percentage that you miss your full house (miss on the
  turn and miss on the river) and subtract that number from 100\%.}
