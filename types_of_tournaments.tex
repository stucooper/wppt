...
There's probably other Niggles I haven't come across yet,
...
Director to only let players rebuy once, and to track the number
of rebuys made.
...
A Bounty is a small prize you get for knocking a player out.
Each player gets a non-playing special Bounty chip.
When you knock a player out, he give you his bounty chip.
...
he refused a 10\% swap offer from me in a tournament I won \$2000 in.
\footnote{He'd just done a swap with another mate so he had enough
swap action for that tournament, otherwise he would have taken my swap}
