...
\begin{itemize}
  ...
  \item The standard of play in the 2005 WSOP is roughly equal to the
    standard of play in the Sydney Pub scene in 2025. 2005 was before
    the era of Game Theory Optimal (GTO) solvers so the playing
    standard was roughly what you'd expect before the Internet changed
    poker forever.
