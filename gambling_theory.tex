...
% CHAPTERLENGTH: 4 pages

% FIXME: The first sentence below is pretty lame; maybe just drop it?
...
Consider the roulette, ``exact number'' bet. I'm in a casino,
...
%% FIXME: I like the exercise below but it makes the chapterlength
%% just over 4 pages, so I'll keep it out unless the chapter shrinks.

%% \arabic{chapter}.4 What do you think happens in a casino if you
