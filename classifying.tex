...
% FIXME: different independent dimensions example than religion
...
% FIXME: I could put in a story here about how PostgreSQL support
% is mostly answering questions from PokerTracker guys
...
thing, but here's a few extra factors I've noticed.
...
general inexperience with live poker. Some will call on a flop
...
your main job in pub poker is to get overpaid for your winning
hands; not to check and sucker a big bluff from the Enemy. There's
...
I like to line up the side markings of the chips so there's
a good five and five appearance on my ten-high stacks. This is just as
useless a trick as chip shuffling, but I find it fun to do.
