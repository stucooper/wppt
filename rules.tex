...
% FIXME: tidy up this paragraph below and add it to the text

% in the old days ppl used to say ``Call and Raise'' but because
% string betting has been thrown out of the game, nobody is allowed
% to do that anymore. In the Call-and-Raise days, it was obvious
% with a preflop min reraise that a 500 preflop bet over a 100 blind was a
% raise of 400, not a bet of 500.
