...
% FIXME: I'd like this to be a \chapter*{Glossary} and not be
% Chapter 47 or whatever, but I still want it mentioned in the table
% of contents
...
\item[Up: Aces Up, Kings Up...] A declaration of a two pair final hand,
the higher pair is mentioned. This comes from Seven Card Stud, where
because everyone has their own seven cards the second pair almost
never counts, what counts is that the player has two pair. For two
players to both have ``Kings Up'' each would need two of the four
Kings in their hand which is obviously rare. In Holdem, declare your
hand as ``two pair, Aces and fives''. In Holdem, the value of the
second pair comes into play a lot more.
